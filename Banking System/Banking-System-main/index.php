...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            ...
            <div><br>
              <marquee  direction="left" height="100px" Scrollamount="20" >
<h3 style="font-weight: 800;font-size: 2em;">Aapka aur humara safar zindagi bhar ka.</h3>
</marquee>
            </div>
      <!-- Activity section -->
      ...
      <footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b>Mohammedzayed Riyajahmed Nejkar</b> <br>PVG'S COET</p>
</footer>
